...
class PrintLog(object):
    ...
    def __init__(self, Delete=False, Log=None, Indent=0, Width=119, LogOnly=False):
        """
        Initializes the logger.
        
        Parameters:
        Delete (bool): Whether to delete the existing log file.
        Log (str): Path to the log file.
        Indent (int): Number of spaces to indent the log messages.
        Width (int): Maximum width of the log messages.
        LogOnly (bool): Whether to only log messages and not print them to the console.
        
        Returns:
        None
        """
        self.Log = Log or os.path.join(os.path.join(ROOT_FOLDER, 'Logs'), 'Antecedent_LOG.txt')
        ...
        if self.Log is not None:
            logPath = os.path.split(self.Log)[0]
            ensure_dir(logPath)
            if Delete:
                try:
    ...
    def Write(self, message):
        """
        Writes a message to the log and prints it to the console.
    ...
    def Wrap(self, message):
        """
        This function wraps a given message and writes it to a log.
        
        Parameters:
        message (str): The message to be wrapped and logged.
