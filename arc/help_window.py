...
class HelpWindow(object):
    ...
    def add_reference(
        self, frame, title, pdf_local_path=None, pdf_url=None, youtube_url=None
    ):
        # Create/Grid LABEL
        label = ttk.Label(frame, text=title, font="Helvetica 10 bold")
        ...
        if pdf_local_path is not None:
            ...
            def open_pdf_reference():
                ...
                version_local_path = os.path.join(
                    version_folder, local_file_name_no_ext
                )
                version_url = "https://raw.githubusercontent.com/erdc/Antecedent-Precipitation-Tool/master/v/{}".format(
                    local_file_name_no_ext
                )
            ...
            pdf_button = ttk.Button(frame, text=pdf_text, command=open_pdf_reference)
        ...
        if youtube_url is not None:
            ...
            youtube_button = ttk.Button(
                frame, text=youtube_text, command=open_youtube_url
            )
